<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SupervisorFinalReport.aspx.cs" Inherits="SupervisorFinalReport"MasterPageFile="MasterPage.master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <body>
        <form id="form1" runat="server">
            <div>
                <h1>Final Report: <asp:Label ID="lblFYPName" runat="server" Text=""></asp:Label></h1>
