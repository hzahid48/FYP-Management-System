...
public partial class StudentHome : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            SqlConnection connectionString = new SqlConnection("Data Source=DESKTOP-IO1J1GI\\SQLEXPRESS;Initial Catalog=tryproj;Integrated Security=True");
            ...
            if (reader.Read())
            {
                ...
                {
                    barData = 0; // Set barData to 0 if the value is NULL
                }
                else
                {
    ...
    protected void TextBox2_TextChanged(object sender, EventArgs e)
    {
       ...
       //Label9.Font.Bold = true;
        ...
        da.Close();
        SqlCommand cmd2 = new SqlCommand("Select group_id from GroupMembers where student_id = @ID", conn);
